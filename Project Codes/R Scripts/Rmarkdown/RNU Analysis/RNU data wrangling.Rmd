...
write.csv2(df_recode,"RNU2.csv",row.names = F)
```
...
write.csv2(v,"VELINGARA.csv",row.names = F)
...
#,"TESSEKRE FORAGE","MBANE","THIEL"
write.csv2(TESSEKRE,"TESSEKRE.csv",row.names = F)
table(TESSEKRE$m13)
```
...
#,"TESSEKRE FORAGE","MBANE","THIEL"
write.csv2(MBANE,"MBANE.csv",row.names = F)
table(MBANE$m13)
```
...
#,"TESSEKRE FORAGE","MBANE","THIEL"
write.csv2(THIEL,"THIEL.csv",row.names = F)
table(THIEL$m13)
```
...
```{r}
df_gr<-rbind(v,THIEL,MBANE,TESSEKRE)
...
ggplot(df_gr) +
 aes(x = m13) +
 geom_bar(fill = "#00441b") +
 labs(x = "Principales sources de revenus", y = "Nombre") +
 coord_flip() +
 theme_bw() +
 facet_wrap(vars(nom_commune_men))
library(ggplot2)
...
ggplot(df_gr) +
 aes(x = m13) +
 geom_bar(fill = "#00441b") +
 labs(x = "Principales sources de revenu", y = "Effectif") +
 coord_flip() +
 theme_minimal() +
 facet_wrap(vars(nom_commune_men), scales = "free_y")
```
